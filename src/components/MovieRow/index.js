...
import {call1, call2, onMouseHoverTime, onMouseHoverLeave} from "../Mixpanel"
...
function MovieRow( { title, items, type } ) {
  ...
  return (
    <div className="movieRow">
        ...
        <div className="movieRow--listarea" onMouseOver={() => onMouseHoverTime()}
          ...
          >
            {
              ...
              items.results.map((item, key) => (
                ...
                item.poster_path !== null &&
                    <div key={key} className="movieRow--item" onClick={() => call1(type, item.id)}>
